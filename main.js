...
class AppComponent {
    ...
    ngOnInit() {
        // Test the Browser start
        if (this.isIEOrEdge) {
            console.log('isIEOrEdge', this.isIEOrEdge);
        }
    }
}
...
module.exports = __webpack_require__(/*! C:\Work\test\7 - test filter pipe\deploy\src\main.ts */"./src/main.ts");
